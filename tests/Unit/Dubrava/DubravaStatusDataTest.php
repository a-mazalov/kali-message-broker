...
use Kali\MessageBroker\Messages\Data\Dubrava\DubravaStatus;
use Kali\MessageBroker\Messages\Message;
use Orchestra\Testbench\TestCase;

class DubravaStatusDataTest extends TestCase
{
    public DubravaStatus $testingData;
    ...
    protected function setUp(): void
    {
        ...
        $this->testingData = new DubravaStatus(id: 1, title: "Dubrava Test Number", body: "Db number", username: "111111", status: 1 );
    }

    public function test_make_message_with_dubrava_status() {
        $message = new Message(job: "DubravaUpdateStatus", data: $this->testingData->toResource());

        $this->assertNotNull($message->getData());
    }

    public function test_create_test_data_from_json() {
        $testingData = DubravaStatus::from('{ "id": "1", "title": "Dubrava Test json", "body": "body", "username": "111111", "status": "1" }');
