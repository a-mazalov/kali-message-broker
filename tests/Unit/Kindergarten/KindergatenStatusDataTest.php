...
use Kali\MessageBroker\Messages\Data\Kindergarten\KindergartenStatus;
use Kali\MessageBroker\Messages\Message;
use Orchestra\Testbench\TestCase;

class KindergatenStatusDataTest extends TestCase
{
    public KindergartenStatus $testingData;
    ...
    protected function setUp(): void
    {
        ...
        $this->testingData = new KindergartenStatus(id: 1, title: "Kindergarten Test Update Status", body: "body test", username: "111111", status: 1 );
    }

    public function test_make_message_with_kg_status() {
        $message = new Message(job: "KindergartenUpdateStatus", data: $this->testingData->toResource());

        $this->assertNotNull($message->getData());
    }

    public function test_create_test_data_from_json() {
        $testingData = KindergartenStatus::from('{ "id": "1", "title": "Kindergarten Test json", "body": "body test", "username": "111111", "status": "1" }');
